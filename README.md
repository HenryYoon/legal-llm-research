...
| R3 | Pipeline 파싱 버그 수정, 영문 시드 600+, binary regex 강제, schema enum | **A2 0.433 > B1** ✅ / A3 0.402 ❌ (SFT 역효과) [분석](results/analysis_r3.md) |

**목표 기준선**: A1 0.454, B1 0.412.

### 결과 (R1/R2, balanced-accuracy / ROUGE-L)

| Task | A1 | B1 | C1 | R1 A3 | R2 A3 | R3 A2 | R3 A3 |
|------|----|----|----|-------|-------|-------|-------|
| hearsay | 0.522 | 0.509 | 0.431 | 0.526 | 0.523 | **0.575** | 0.516 |
| personal_jurisdiction | 0.591 | 0.500 | 0.663 | 0.500 | 0.500 | 0.511 | 0.500 |
| rule_qa (ROUGE-L) | 0.121 | 0.139 | 0.113 | 0.092 | 0.117 | 0.159 | 0.134 |
| textualism_tool | 0.583 | 0.500 | 0.471 | 0.489 | 0.469 | 0.486 | 0.460 |
| **평균** | **0.454** | 0.412 | 0.419 | 0.402 | 0.402 | **0.433** | 0.402 |
